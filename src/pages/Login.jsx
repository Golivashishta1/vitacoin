...
export default function Login() {
  ...
  return (
    <div className="min-h-screen flex">
        ...
        >
          <div className="bg-black/40 backdrop-blur-xl border border-yellow-500/20 rounded-2xl p-8 shadow-2xl">
            <div className="text-center mb-8">
              ...
              <p className="text-gray-400">Sign in to your Bolt account</p>
            </div>
            ...
            >
              ...
              <Link to="/signup" className="text-yellow-500 hover:text-yellow-400 font-medium transition-colors duration-200">
                Sign Up
              </Link>
            </motion.p>
          </div>
      ...
      <div className="flex-1 flex items-center justify-center bg-gradient-to-br from-black-500/10 to-black-600/5 p-8">
